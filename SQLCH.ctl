...
(define-param kpts 3)	;number of points (+2) where we should calculate the band structure
...
(define G (vector3 0.4 0 0))	; Gamma point
(define X (vector3 0.5 0 0))	; X point
(set! k-points (list G X))
(set! k-points (interpolate kpts k-points))
